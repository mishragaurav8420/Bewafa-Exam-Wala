...
export declare abstract class BaseSliderAdapter {
...
export declare abstract class ThumbSliderAdapter extends BaseSliderAdapter {
    abstract get thumbSize(): number;
}
export declare abstract class SliderAdapter extends BaseSliderAdapter {

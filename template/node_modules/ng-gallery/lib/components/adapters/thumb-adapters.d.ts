...
export declare class HorizontalThumbAdapter extends HorizontalCommonAdapter implements ThumbSliderAdapter {
    slider: HTMLElement;
...
export declare class VerticalThumbAdapter extends VerticalCommonAdapter implements ThumbSliderAdapter {
    slider: HTMLElement;
    config: GalleryConfig;
    get thumbSize(): number;
    get isContentLessThanContainer(): boolean;

...
export declare class HorizontalAdapter extends HorizontalCommonAdapter implements SliderAdapter {
    slider: HTMLElement;
    ...
    getPanDelta(e: any): number;
    getPanVelocity(e: any): number;
    getCentralizerStartSize(): number;
    getCentralizerEndSize(): number;
}
export declare class VerticalAdapter extends VerticalCommonAdapter implements SliderAdapter {
    slider: HTMLElement;
    config: GalleryConfig;
    get measureIndex(): number;
    get isContentLessThanContainer(): boolean;

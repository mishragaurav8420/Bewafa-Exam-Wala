...
export declare class SmoothScrollManager {
     ...
     */
    private get _now();
    constructor(_document: Document, customDefaultOptions: SmoothScrollToOptions, _platform: Platform);
    /**
    ...
    static ɵfac: i0.ɵɵFactoryDeclaration<SmoothScrollManager, [null, { optional: true; }, null]>;

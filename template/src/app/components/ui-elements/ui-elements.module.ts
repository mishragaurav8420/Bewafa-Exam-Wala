...
@NgModule({
  declarations: [TypographyComponent, AvatarsComponent, HelperClassesComponent, GridComponent, TagNPillsComponent, SpinnersComponent, ShadowComponent, ListComponent, RibbionsComponent, StepsComponent, BreadcrumbComponent],
  imports: [
    CommonModule,

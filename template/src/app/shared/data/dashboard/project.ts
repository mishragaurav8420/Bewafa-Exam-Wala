...
export var showXAxis : any= true;
export var showYAxis : any= true;
export var gradient : any= false;
export var showLegend : any= false;
export var showXAxisLabel: any = true;
export var showYAxisLabel : any = true;
